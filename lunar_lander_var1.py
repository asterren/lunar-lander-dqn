...
env = gym.wrappers.RecordVideo(
    env, 
    video_folder="variation_1/recordings", 
...
for episode in range(num_episodes):
    ...
    while not done:
        ...
        if len(memory) > BATCH_SIZE:
            ...
            curr_q = policy_net(b_state).gather(1, b_action.unsqueeze(1)).squeeze()
            ...
            q_values_history.append(curr_q.mean().item())

        # TODO: Update target network periodically
        if steps % 100 == 0: # Note: This usually happens inside loop or outside per ep
            pass
...
test_env = gym.wrappers.RecordVideo(
    ...
    video_folder="variation_1/test_recordings", 
...
torch.save(policy_net.state_dict(), "variation_1/dqn_lunar_lander_v1.pth")

fig, axs = plt.subplots(2, 2, figsize=(15, 12))
fig.suptitle('DQN Training and Analysis var1 higher lr', fontsize=16)
...
plt.savefig('variation_1/dqn_analysis_v1.png')
plt.show()
