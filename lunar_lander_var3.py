...
env = gym.wrappers.RecordVideo(
    env, 
    video_folder="variation_3/recordings", 
...
class QNetwork(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        # Using manual layers instead of Sequential
...
class ReplayBuffer:
    ...
    def sample(self, batch_size):
        # Manual unpacking for the "student" look
...
for episode in range(num_episodes):
    ...
    while not done:
        ...
        if len(memory) > BATCH_SIZE:
            ...
            # Unsqueeze and gather for Q-values
...
test_env = gym.wrappers.RecordVideo(
    ...
    video_folder="variation_3/test_recordings", 
...
torch.save(policy_net.state_dict(), "variation_3/dqn_lunar_lander_v3.pth")

fig, axs = plt.subplots(2, 2, figsize=(15, 12))
fig.suptitle('DQN Training and Analysis var3 slower traget update', fontsize=16)
...
plt.savefig('variation_3/dqn_analysis_v3.png')
plt.show()
